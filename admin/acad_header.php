                        ...
                        <tr>
                          ...
                          <td>
                            <div class="table-data-feature">
                              ...
                              <a
                                href="./backend/delete.php?id=<?php echo $row['acad_header_id'];?>&action=del-acadheader"
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">
              INSERT ACADEMICS HEADER DETAILS
            </h5>
            <button
              type="button"
              class="close"
          ...
          <div class="modal-body">
            ...
            >
              ...
              <input
                type="file"
                name="acad_header_img"
                class="img-acad-header"
              />
