...
<html lang="en">
  ...
  <body>
                ...
                <div class="col-md-12">
                  ...
                  <div class="table-responsive m-b-40">
                    <div class="float-left pb-4">
                      <h3>Contacts | Contacts Header</h3>
                    </div>
                    ...
                    <table class="table table-borderless table-data3">
                      ...
                      <tbody>
                        <?php
                                    ...
                                    ?>
                        <tr>
                          <td><?php echo $row['cont_header_id'];?></td>
                          <td>
                            <img
                              src="../<?php echo $row['cont_header_img']?>"
                            />
                          </td>
                          <td></td>
                          <td></td>
    ...
    <!-- Modal -->
    <div class="modal" id="cont_header" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Contacts Header</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            <form
              action="./backend/insert-banner.php?action=add-contheader"
              method="POST"
              enctype="multipart/form-data"
            >
              <p>Please input image to display.</p>
              <label class="label">Image</label>
              <input type="file" name="cont_header_img" class="img-banner" />
              <br />
              <br />
              <input
                type="submit"
