...
<html lang="en">
  ...
  <body>
                ...
                <div class="col-md-12">
                  ...
                  <div class="table-responsive m-b-40">
                    <div class="float-left pb-4">
                      <h3>Contacts | President's Office</h3>
                    </div>
                    ...
                    <table class="table table-borderless table-data3">
                      ...
                      <tbody>
                        <?php
                                    ...
                                    ?>
                        <tr>
                          <td><?php echo $row['cont_pres_id'];?></td>
                          <td>
                            <img src="../<?php echo $row['cont_pres_img']?>" />
                          </td>
                          <td><?php echo $row['cont_pres_title'];?></td>
                          <td></td>
                          <td>
                            <div class="table-data-feature">
                              <a
                                href="edit_post/edit_cont_pres1.php?id=<?php echo $row['cont_pres_id'];?>&action=edit-contpres"
                              >
                                <button
                                  class="item"
                                  data-toggle="tooltip"
                              ...
                              <a
                                href="./backend/delete.php?id=<?php echo $row['cont_pres_id'];?>&action=del-contpres"
                  ...
                  <table class="table table-borderless table-data3 mt-4">
                    ...
                    <tbody>
                      <?php
                                    ...
                                    ?>
                      <tr>
                        <td><?php echo $row['cont_pres2_id'];?></td>
                        <td><?php echo $row['cont_pres2_cont'];?></td>
                        <td></td>
                        <td></td>
                        <td>
                          <div class="table-data-feature">
                            <a
                              href="edit_post/edit_cont_pres2.php?id=<?php echo $row['cont_pres2_id'];?>&action=edit-contpres2"
                            >
                              <button
                                class="item"
                                data-toggle="tooltip"
                            ...
                            <a
                              href="./backend/delete.php?id=<?php echo $row['cont_pres2_id'];?>&action=del-contpres2"
                              onclick="confirm('Are you sure you want delete?');"
                            >
                              <button
                                class="item"
    ...
    <!-- Modal -->
    <div class="modal" id="cont_pres" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">President's Office Contact</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            <form
              action="./backend/update.php?action=upd-contpres"
              method="POST"
            ...
            >
              ...
              <input
                ...
                type="text"
                placeholder="Title"
                name="cont_pres_title"
              />
              <br />
              <p>Please input image to display.</p>
              <label class="label">Image</label>
              <input type="file" name="cont_pres_img" class="img-banner" />
              <br />
              <br />
              <input
                type="submit"
    ...
    <!-- Modal Table 2 -->
    <div class="modal" id="cont_pres2" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">President's Office Contact</h5>
          ...
          <div class="modal-body">
            <form
              action="./backend/update.php?action=upd-contpres2"
              method="POST"
              enctype="multipart/form-data"
            >
              <p>Add New Contact</p>
