              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Academics | Education Master Degree Courses</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-acadedu2"
                    method="POST" enctype="multipart/form-data"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from acad_edu2 where acad_edu2_id=$id;");
                                      while($row=mysqli_fetch_assoc($query))
                                      {
                                    ?>
                    <div class="form-group">
                      <label for="exampleFormControlTextarea1"
                        >Master Degree Course Name</label
                      >
                      <textarea
                        Required
                        class="form-control"
                        name="acad_edu2_newmas"
                        id="exampleFormControlTextarea1"
                        rows="2"
                      >
<?php echo $row['acad_edu2_mas'];?></textarea
                      >
                    </div>
                    <input
                      type="submit"
