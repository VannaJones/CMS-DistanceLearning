            ...
            <div class="container-fluid">
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-about_rat"
                    method="POST"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from about_rat where about_rat_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="about_rat_newtitle"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['about_rat_title'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <textarea
                        Required
                        class="form-control"
                        name="about_rat_newdesc"
                        
                        id="exampleFormControlTextarea1"
                        rows="5"
                      ><?php echo $row['about_rat_desc'];?></textarea>
                    </div>
                    <input
                      type="submit"
