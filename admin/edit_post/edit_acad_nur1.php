              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Academics | Nursing Program Description</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-acadnur1"
                    method="POST" enctype="multipart/form-data"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from acad_nur1 where acad_nur1_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="acad_nur1_newtitle"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['acad_nur1_title'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="acad_nur1_newbut"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['acad_nur1_but'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        type="file"
                        name="acad_nur1_newimg"
                        class="img-acad"
                        value="<?php echo $row['acad_nur1_img'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <textarea
                        Required
                        class="form-control"
                        name="acad_nur1_newdesc"
                        id="exampleFormControlTextarea1"
                        rows="5"
                      >
<?php echo $row['acad_nur1_desc'];?></textarea
                      >
                    </div>
                    <input
                      type="submit"
