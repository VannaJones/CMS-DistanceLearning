              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Academics | Nursing Master Degree Courses</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-acadnur2"
                    method="POST" enctype="multipart/form-data"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from acad_nur2 where acad_nur2_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <textarea
                        Required
                        class="form-control"
                        name="acad_nur2_newmas"
                        id="exampleFormControlTextarea1"
                        rows="2"
                      >
<?php echo $row['acad_nur2_mas'];?></textarea
                      >
                    </div>
                    <input
                      type="submit"
