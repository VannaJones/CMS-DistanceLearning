...
<html lang="en">
  <head>
    ...
    <!-- Title Page-->
    <title>CMS | Edit Academics</title>
              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Academics | Education Program Description</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-acadedu1"
                    method="POST" enctype="multipart/form-data"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from acad_edu1 where acad_edu1_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="acad_edu1_newtitle"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['acad_edu1_title'];?>"
                      />
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Button Label Name</label>
                      <input
                        Required
                        name="acad_edu1_newbut"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['acad_edu1_but'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        type="file"
                        name="acad_edu1_newimg"
                        class="img-acad"
                        value="<?php echo $row['acad_edu1_img'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <textarea
                        Required
                        class="form-control"
                        name="acad_edu1_newdesc"
                        id="exampleFormControlTextarea1"
                        rows="5"
                      >
<?php echo $row['acad_edu1_desc'];?></textarea
                      >
                    </div>
                    <input
                      type="submit"
