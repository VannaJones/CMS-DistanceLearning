              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Contacts | President's Office</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-contpres"
                    method="POST" enctype="multipart/form-data"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from cont_pres where cont_pres_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="cont_pres_newtitle"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['cont_pres_title'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        type="file"
                        name="cont_pres_newimg"
                        class="img-acad"
                        value="<?php echo $row['cont_pres_img'];?>"
                      />
                    </div>
                    <input
                      type="submit"
