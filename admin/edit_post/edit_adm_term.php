              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Admission Terms and Policy</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-admterm"
                    method="POST"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from adm_term where adm_term_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="adm_term_newtitle"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['adm_term_title'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <textarea
                        Required
                        class="form-control"
                        name="adm_term_newcont"
                        
                        id="exampleFormControlTextarea1"
                        rows="5"
                      ><?php echo $row['adm_term_cont'];?></textarea>
                    </div>
                    <input
                      type="submit"
