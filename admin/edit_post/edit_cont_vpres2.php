              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Contacts | Vice President's Office Contacts</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-contvpres2"
                    method="POST" enctype="multipart/form-data"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from cont_vpres2 where cont_vpres2_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="cont_vpres2_newcont"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['cont_vpres2_cont'];?>"
                      />
                    </div>
                    <input
                      type="submit"
