...
<html lang="en">
  <head>
    ...
    <!-- Title Page-->
    <title>CMS | Admission Enrolment Procedures</title>
              ...
              <div class="row m-t-10">
                <div class="col-md-12">
                  ...
                  <div class="float-left">
                    <h3>Edit | Admission Enrolment Procedures</h3>
                  </div>
                  <br /><br />
                  <form
                    action="../backend/edit.php?id=<?php echo $id;?>&action=edit-admenrol"
                    method="POST"
                  >
                    <?php
                                      $query=mysqli_query($con,"SELECT * from adm_enrol where adm_enr_id=$id;");
                    ...
                    <div class="form-group">
                      ...
                      <input
                        Required
                        name="adm_enr_newtitle"
                        type="text"
                        class="form-control"
                        id="exampleFormControlInput1"
                        value="<?php echo $row['adm_enr_title'];?>"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <textarea
                        Required
                        class="form-control"
                        name="adm_enr_newcont"
                        
                        id="exampleFormControlTextarea1"
                        rows="5"
                      ><?php echo $row['adm_enr_cont'];?></textarea>
                    </div>
                    <input
                      type="submit"
