                    ...
                    <table class="table table-borderless table-data3">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img
                              src="../sample-img/<?php echo $row['about_img']; ?>"
                            />
                          </td>
                          <td></td>
                          <td></td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            >
              ...
              <input type="file" name="about_img" class="img-about-header" />
