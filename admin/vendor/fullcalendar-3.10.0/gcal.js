...
*/
        ...
        /***/ 270: /***/ function (module, exports, __webpack_require__) {
          ...
          exportHooks.EventSourceParser.registerClass(
            GcalEventSource_1.default
          );
        ...
        /***/ 271: /***/ function (module, exports, __webpack_require__) {
          ...
          var GcalEventSource = /** @class */ (function (_super) {
            ...
            GcalEventSource.parse = function (rawInput, calendar) {
              ...
              if (rawProps) {
                return fullcalendar_1.EventSource.parse.call(
                  this,
                  rawProps,
                  calendar
                );
            ...
            GcalEventSource.prototype.fetch = function (start, end, timezone) {
              ...
              return fullcalendar_1.Promise.construct(function (
                onResolve,
                onReject
              ) {
                $.ajax(
                    ...
                    ajaxSettings,
                    {
                      ...
                      success: function (responseData, status, xhr) {
                        ...
                        if (responseData.error) {
                          ...
                          successRes = fullcalendar_1.applyAll(
                            onSuccess,
                            _this,
            ...
            GcalEventSource.prototype.gcalItemToRawEventDef = function (
              item,
              gcalTimezone
            ) {
            ...
            GcalEventSource.prototype.buildRequestParams = function (
              start,
              end,
              timezone
            ) {
              var apiKey =
                ...
                this.calendar.opt("googleCalendarApiKey");
              var params;
              if (!apiKey) {
                this.reportError(
            ...
            GcalEventSource.prototype.reportError = function (
              message,
              apiErrorObjs
            ) {
              ...
              fullcalendar_1.warn.apply(
                null,
                [message].concat(apiErrorObjs || [])
              );
            };
            GcalEventSource.prototype.getPrimitive = function () {
              return this.googleCalendarId;
            };
            GcalEventSource.prototype.applyManualStandardProps = function (
              rawProps
            ) {
              var superSuccess =
                fullcalendar_1.EventSource.prototype.applyManualStandardProps.apply(
                  this,
                  arguments
                );
          ...
          function parseGoogleCalendarId(url) {
            ...
            if (
              /^[^\/]+@([^\/\.]+\.)*(google|googlemail|gmail)\.com$/.test(url)
            ) {
              return url;
            } else if (
              (match =
