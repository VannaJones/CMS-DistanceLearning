...
<html lang="en">
  ...
  <body>
                    ...
                    <table class="table table-borderless table-data3">
                      ...
                      <tbody>
                        <?php
                                    ...
                                    ?>
                        <tr>
                          <td><?php echo $row['about_vis_id'];?></td>
                          <td><?php echo $row['about_vis_title'];?></td>
                          <td><?php echo $row['about_vis_desc'];?></td>
                          <td></td>
                          <td>
                            <div class="table-data-feature">
                              <a
                                href="edit_post/edit_about_vis.php?id=<?php echo $row['about_vis_id'];?>&action=edit-aboutvis">
                                <button
                                  class="item"
                                  data-toggle="tooltip"
                                  data-placement="top"
                              ...
                              <a
                                href="./backend/delete.php?id=<?php echo $row['about_vis_id'];?>&action=del-aboutvis"
    ...
    <!-- Modal -->
    <div class="modal" id="about_vis" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">About Vission Details</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            <form
              action="./backend/update.php?action=upd-aboutvis"
              method="POST"
            >
              <p>Add Distance Learning Vision Informations</p>
              <input
                class="form-control w-100 mt-3"
                type="text"
                placeholder="Title"
                name="about_vis_title"
              />
              <br />
              <textarea
                name="about_vis_desc"
