  ...
  <body>
    ...
    <div class="container pb-4">
      ...
      <div class="row bg-title p-2">
        <div class="col-lg">
          <h2><?php echo $row['acad_edu1_title'];?></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-8 p-4 bg-content">
          ...
          <h4>
            <b><?php echo $row['acad_edu1_but'];?></b>
          </h4>
          <?php } ?>
          <ul style="list-style-type: disc">
            <?php
                                      ...
                                      {
                                    ?>
            <li><?php echo $row['acad_edu2_mas'];?></li>
            <?php } ?>
          </ul>
        </div>
        <div class="col-lg-4 p-3 bg-pdf">
          ...
          <ul style="list-style-type: disc">
            ...
            <li>
              <a
                href="./<?php echo $row['acad_edu3_file'];?>"
                style="text-decoration: none"
                download
                ><?php echo $row['acad_edu3_filename'];?></a
              >
            </li>
            <?php } ?>
          </ul>
